...
otu_perm    <- readRDS('~/Desktop/Weinstock_DOMA/Viewer/Version 2 - Centered Log Ratio/Permutation Matrix/doma_otu_additive_perm_1000_v2.rds')
genus_perm  <- readRDS('~/Desktop/Weinstock_DOMA/Viewer/Version 2 - Centered Log Ratio/Permutation Matrix/doma_genus_additive_perm_1000_v2.rds')
family_perm <- readRDS('~/Desktop/Weinstock_DOMA/Viewer/Version 2 - Centered Log Ratio/Permutation Matrix/doma_family_additive_perm_1000_v2.rds')
order_perm  <- readRDS('~/Desktop/Weinstock_DOMA/Viewer/Version 2 - Centered Log Ratio/Permutation Matrix/doma_order_additive_perm_1000_v2.rds')
class_perm  <- readRDS('~/Desktop/Weinstock_DOMA/Viewer/Version 2 - Centered Log Ratio/Permutation Matrix/doma_class_additive_perm_1000_v2.rds')
phylum_perm <- readRDS('~/Desktop/Weinstock_DOMA/Viewer/Version 2 - Centered Log Ratio/Permutation Matrix/doma_phylum_additive_perm_1000_v2.rds')
