### This shell script finds age effect QTLs using R script from:
...
scan1_mat='doma_class_additive_scan_v1.rds'
dataset_expr='dataset.doma.class|data|rz'
thr='6'
num_cores='1'
type_scan='age_int'
prob='.95'
cis_threshold='NA'
int_mat='doma_class_cohort.age_scan_v1.rds'
